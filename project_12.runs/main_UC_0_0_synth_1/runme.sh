...
HD_PWD='D:/228491/PUL/MGR/project_12/project_12.runs/main_UC_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_UC_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_UC_0_0.tcl
